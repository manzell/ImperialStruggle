...
namespace ImperialStruggle
{
    public class Game : SerializedMonoBehaviour
    {
        ...
        public static IEnumerable<AdvantageTile> AdvantageTiles { get; private set; }
        ...
        [SerializeField] List<AdvantageData> advantageTiles; 
        ...
        private void Awake()
        {
            ...
            AdvantageTiles = advantageTiles.Select(tile => new AdvantageTile(tile)); 
